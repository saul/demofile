    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.cvars.push(
            $root.CMsg_CVars.CVar.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.classes.push(
            $root.CSVCMsg_ClassInfo.class_t.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.props.push(
            $root.CSVCMsg_SendTable.sendprop_t.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.keys.push(
            $root.CSVCMsg_GameEvent.key_t.decode(reader, reader.uint32())
          );
          break;
        case 4:
          message.passthrough = reader.int32();
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.descriptors.push(
            $root.CSVCMsg_GameEventList.descriptor_t.decode(
              reader,
              reader.uint32()
            )
          );
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            if (!(message.keys && message.keys.length)) message.keys = [];
            message.keys.push(
              $root.CSVCMsg_GameEventList.key_t.decode(reader, reader.uint32())
            );
            break;
          default:
            reader.skipType(tag & 7);
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.sounds.push(
            $root.CSVCMsg_Sounds.sounddata_t.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
