...
import { SPROP_EXCLUDE, SPROP_INSIDEARRAY, SPROP_UNSIGNED, SPROP_NOSCALE, PropType } from '../props';
  ...
  fs.readFile(path, function (err, buffer) {
    ...
    demoFile.entities.on('datatablesready', () => {
      ...
      for (let dt of demoFile.entities.dataTables) {
        ...
        for (let prop of dt.props) {
          ...
          if (prop.type == PropType.Int) {
            ...
            throw `Unexpected prop type ${prop.type}`;
      ...
      for (let serverClass of demoFile.entities.serverClasses) {
        let dataTableNames = _.keys(_.groupBy(serverClass.flattenedProps, flat => flat.table.netTableName));
