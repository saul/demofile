...
export declare const CSVCMsgServerInfo: {
    ...
    fromPartial<I extends {
        ...
        ugcMapId?: string | number | Long.Long | undefined;
    } & {
        protocol?: number | undefined;
        serverCount?: number | undefined;
        isDedicated?: boolean | undefined;
        ...
        hostName?: string | undefined;
        publicIp?: number | undefined;
        ugcMapId?: string | number | (Long.Long & {
            high: number;
            low: number;
            unsigned: boolean;
            add: (addend: string | number | Long.Long) => Long.Long;
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["ugcMapId"], keyof Long.Long>, never>) | undefined;
...
export declare const CSVCMsgGameEvent: {
    ...
    fromPartial<I extends {
        ...
        keys?: {
            ...
            valUint64?: string | number | Long.Long | undefined;
        ...
        keys?: ({
            ...
            valByte?: number | undefined;
            valBool?: boolean | undefined;
            valUint64?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
                add: (addend: string | number | Long.Long) => Long.Long;
                ...
                toUnsigned: () => Long.Long;
                xor: (other: string | number | Long.Long) => Long.Long;
            } & Record<Exclude<keyof I["keys"][number]["valUint64"], keyof Long.Long>, never>) | undefined;
            valWstring?: Uint8Array | undefined;
...
export declare const CSVCMsgGameEvent_keyT: {
    ...
    fromPartial<I extends {
        ...
        valUint64?: string | number | (Long.Long & {
            ...
            toUnsigned: () => Long.Long;
            xor: (other: string | number | Long.Long) => Long.Long;
        } & Record<Exclude<keyof I["valUint64"], keyof Long.Long>, never>) | undefined;
        valWstring?: Uint8Array | undefined;
